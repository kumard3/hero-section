        ...
        <section className="flex   flex-col items-center justify-center">
          ...
          <div className="max-w-xl">
            <p className="outerSans py-12 text-left">
              ...
              Reprehenderit nostrum, ab perspiciatis, illo laudantium libero quo
              praesentium eveniet quae saepe deserunt aliquid ducimus quibusdam.
              Veniam earum perspiciatis laudantium rem cupiditate.{" "}
            </p>
          </div>
