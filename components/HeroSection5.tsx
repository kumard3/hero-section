...
export default function HeroSection5() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      <nav className="absolute  flex justify-between  items-center px-5 py-3 w-full z-10">
        <div>
          <img
        ...
        <div>
          <button className="border-2 rounded-xl border-[#FFA503] w-[170.13px] h-[60.05px] text-xl Rubik-SemiBold">
            Login
          </button>
        </div>
      </nav>
      <div className="grid lg:grid-cols-2 items-center pt-20 lg:pt-0 overflow-hidden">
        <div className="px-3 sm:px-4 pt-8">
          <h1 className="Rubik-Medium  text-[55px] leading-[1.2] max-w-3xl text-left">
          ...
          <div className="relative overflow-hidden flex max-w-3xl items-center ">
            <div className="max-w-[345px] h-[70px] relative overflow-hidden ">
              ...
              <input
                ...
                className="Rubik-Bold text-lg -top-1 rounded-br-3xl  bg-transparent focus:outline-none px-4 text-white z-10 w-full absolute inset-0"
              />
            </div>
            <svg
              width="153"
        ...
        <div className="relative overflow-hidden  object-contain">
          <img src={image} alt="Upload" className=" h-full object-fill" />
        </div>
      </div>
    </div>
  )
