        ...
        <div className=" relative z-10 flex h-full w-full justify-between px-10  py-10 ">
          <section className="flex   flex-col items-center justify-center">
            <div className="relative w-full max-w-xl">
              <h1 className="flex flex-col text-left font-mono text-7xl font-bold">
                NFT that are Out of this{" "}
                <span className="flex items-center">
                  world
                  <div className="">
                    <Image src="/KEEPSMILING.png" width="60" height="60" />
                  </div>{" "}
                </span>{" "}
              </h1>
            </div>
            <div className="max-w-xl">
              <p className="py-12 text-left">
                {" "}
            ...
            <div className="relative flex w-full justify-around">
              <button className="relative flex h-10 w-32 items-center justify-center ">
                ...
                <h1 className="absolute z-10 font-mono text-2xl font-bold text-black ">
                  Explore
                </h1>
              </button>
              <button className="font-mono text-2xl font-bold ">Learn more</button>
            </div>
          </section>
